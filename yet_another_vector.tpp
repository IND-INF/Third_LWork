...
template <class T>
Vector<T>::Enumerator::Enumerator(const Enumerator &enumerator){
    typename ImmutableArraySequence<T>::Enumerator *srcEnumerator =
                dynamic_cast<typename ImmutableArraySequence<T>::Enumerator*>(enumerator.innerEnumerator);
    innerEnumerator = new typename ImmutableArraySequence<T>::Enumerator(*srcEnumerator);
}

template <class T>
Vector<T>::Enumerator::~Enumerator(){
...
Vector<T> operator+(const Vector<T> &lhv, const Vector<T> &rhv){
    ...
    try{
        ...
        Vector<T> res(lhv.items->DirectCopy());
        return res;
    }
