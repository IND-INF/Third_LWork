...
template <class T, class Derived>
ListSequence<T,Derived>::Enumerator::Enumerator(const Enumerator &enumerator){
    typename LinkedList<T>::Enumerator *srcEnumerator =
                dynamic_cast<typename LinkedList<T>::Enumerator*>(enumerator.innerEnumerator);
    innerEnumerator = new typename LinkedList<T>::Enumerator(*srcEnumerator);
}

template <class T, class Derived>
ListSequence<T,Derived>::Enumerator::~Enumerator(){
